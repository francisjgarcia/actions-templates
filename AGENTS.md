...
These instructions are for autonomous AI agents when generating code in this repository. It covers the project overview, repository structure, CI/CD pipeline flow, coding conventions, and specific rules to follow when modifying files or generating code.
